					...
					<nav className="header__center">
						{
							!((Number(JSON.parse(
								...
								localStorage.getItem("user"),
							)?.date_credit) && (new Date(JSON.parse(
								localStorage.getItem("user"),
							).date_credit).getTime()) >= new Date().getTime()) && (
								<>
									<a
			...
			>
				<div className="popupMenuMobile__body">
					...
					<div className="popupMenuMobile__body-list">
						{localStorage.getItem("user") && !((Number(JSON.parse(
							localStorage.getItem("user"),
						).credit) > 0) && (JSON.parse(
							localStorage.getItem("user"),
						)?.date_credit) && (new Date(JSON.parse(
