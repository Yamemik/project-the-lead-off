        ...
        <>
                ...
                <div className="containerLanding">
                    <div className="bannerLanding__info">
                        <h1 className="bannerLanding__info-title">
                            CRM-система управления бизнес‑процессами в сфере продаж
                        </h1>
                        <p className="bannerLanding__info-text">
                            Вся информация для работы собрана в одном месте: наглядный список задач для
                            сотрудников,прозрачность в работе для руководителей, полные отчеты для директоров
                        </p>
            ...
            <section className="advantagesLanding">
                <div class="containerLanding">
                    <h2 className="advantagesLanding__title titleLanding">Преимущества</h2>
                    <div className="advantagesLanding__content">
                        <div className="advantagesLanding__content-item advantagesLanding__content-item--blue">
                            <div className="advantagesLanding__content-item-info">
                                <h6 className="advantagesLanding__content-item-info-title">
                                    {advantages.length > 0 && advantages[0]?.title ? advantages[0].title : "Сервис"}
                                </h6>
                                <p className="advantagesLanding__content-item-info-text">
                                    {advantages.length > 0 && advantages[0]?.text
                                        ? advantages[0].text
                        ...
                        <div className="advantagesLanding__content-item advantagesLanding__content-item--green">
                            <div className="advantagesLanding__content-item-info">
                                <h6 className="advantagesLanding__content-item-info-title">
                                    {advantages.length > 0 && advantages[1]?.title ? advantages[1].title : "Сервис"}
                                </h6>
                                <p className="advantagesLanding__content-item-info-text">
                                {advantages.length > 0 && advantages[1]?.text
                                        ? advantages[1].text
                                        : "Умная платформа для поддержки клиентов, партнеров и сотрудников по телефону, в почте и мессенджерах"}
                                </p>
                            </div>
                        ...
                        <div className="advantagesLanding__content-item advantagesLanding__content-item--purple">
                            <div className="advantagesLanding__content-item-info">
                                <h6 className="advantagesLanding__content-item-info-title">
                                    {advantages.length > 0 && advantages[2]?.title ? advantages[2].title : "Сервис"}
                                </h6>
                                <p className="advantagesLanding__content-item-info-text">
                                {advantages.length > 0 && advantages[2]?.text
                                        ? advantages[2].text
                                        : "Умная платформа для поддержки клиентов, партнеров и сотрудников по телефону, в почте и мессенджерах"}
                                </p>
                            </div>
                        ...
                        <div className="advantagesLanding__content-item advantagesLanding__content-item--purple">
                            <div className="advantagesLanding__content-item-info">
                                <h6 className="advantagesLanding__content-item-info-title">
                                    {advantages.length > 0 && advantages[3]?.title ? advantages[3].title : "Сервис"}
                                </h6>
                                <p className="advantagesLanding__content-item-info-text">
                                {advantages.length > 0 && advantages[3]?.text
                                        ? advantages[3].text
                                        : "Умная платформа для поддержки клиентов, партнеров и сотрудников по телефону, в почте и мессенджерах"}
                                </p>
                            </div>
                        ...
                        <div className="advantagesLanding__content-item advantagesLanding__content-item--blue">
                            <div className="advantagesLanding__content-item-info">
                                <h6 className="advantagesLanding__content-item-info-title">
                                    {advantages.length > 0 && advantages[4]?.title ? advantages[4].title : "Сервис"}
                                </h6>
                                <p className="advantagesLanding__content-item-info-text">
                                {advantages.length > 0 && advantages[4]?.text
                                        ? advantages[4].text
                                        : "Умная платформа для поддержки клиентов, партнеров и сотрудников по телефону, в почте и мессенджерах"}
                                </p>
                            </div>
                        ...
                        <div className="advantagesLanding__content-item advantagesLanding__content-item--green">
                            <div className="advantagesLanding__content-item-info">
                                <h6 className="advantagesLanding__content-item-info-title">
                                    {advantages.length > 0 && advantages[5]?.title ? advantages[5].title : "Сервис"}
                                </h6>
                                <p className="advantagesLanding__content-item-info-text">
                                {advantages.length > 0 && advantages[5]?.text
                                        ? advantages[5].text
                                        : "Умная платформа для поддержки клиентов, партнеров и сотрудников по телефону, в почте и мессенджерах"}
                                </p>
                            </div>
                    ...
                    <div className="advantagesLanding__extra">
                        <h6 className="advantagesLanding__extra-title">Мы в цифрах</h6>
                        <div className="advantagesLanding__extra-items">
                            <div className="advantagesLanding__extra-items-item">
                                <div className="advantagesLanding__extra-items-item-number">8 000</div>
                                <div className="advantagesLanding__extra-items-item-opinion">клиентов</div>
                            </div>
                            <div className="advantagesLanding__extra-items-item">
                                <div className="advantagesLanding__extra-items-item-number">50 000</div>
                                <div className="advantagesLanding__extra-items-item-opinion">заявок</div>
                            </div>
                            <div className="advantagesLanding__extra-items-item">
                                <div className="advantagesLanding__extra-items-item-number">5 000</div>
                                <div className="advantagesLanding__extra-items-item-opinion">успешных сделок</div>
                            </div>
                        </div>
                        <img className="advantagesLanding__extra-img" src="/img/landing/extra-img.png" alt="" />
                    </div>
                </div>
            </section>
                    ...
                    <div class="tarifs__items">
                        <div class="tarifs__items-item">
                            ...
                            <p class="tarifs__items-item-opinion">
                                Задачи и проекты для работы распределенных команд и взаимодействия отделов, без базы
                                клиентов
                            </p>
                            <ul class="tarifs__items-item-list">
                                <li class="tarifs__items-item-list-item">До 200 пользователей</li>
                                <li class="tarifs__items-item-list-item">Выделеннные облачные ресурсы</li>
                                <li class="tarifs__items-item-list-item">Автономность решения</li>
                                <li class="tarifs__items-item-list-item">SLA 99,95%</li>
                            </ul>
                            {/* <div className="tarifs__items-item-price">
                                <p className="tarifs__items-item-price-main">Бесплатно</p>
                            </div> */}
                            <Button
                                click={() => (window.location.href = "/platform/demo")}
                                type="fill"
                                text="Попробовать"
                            />
                        </div>
                        <div class="tarifs__items-item">
                            ...
                            {/* <div className="tarifs__items-item-price">
                                <p className="tarifs__items-item-price-main">384₽</p>
                                <p class="tarifs__items-item-price-addition">549₽</p>
                            </div> */}
                            <Button
                                click={() => (window.location.href = "/platform/demo")}
                                type="fill"
                ...
                <div class="containerLanding">
                    ...
                    <div class="feedbacks__content">
                            ...
                            <SwiperSlide>
                                <div className="feedbacks__content-feedback">
                                    ...
                                    <div className="feedbacks__content-feedback-info">
                                        <h6 class="feedbacks__content-feedback-info-title">Иванов Иван Иванович</h6>
                                        <p class="feedbacks__content-feedback-info-tag">
                                            Генеральный директор компании «Юмисофт»
                                        </p>
                                        <p class="feedbacks__content-feedback-info-text">
                                            Отличная программа для планирования, контроля и управления всеми задачами.
                                            Она помогает нам организовать внутренние процессы. В ней мы ставим задачи
                                            сотрудникам и контролируем сроки. Это удобно: теперь никто не забывает
                                            о своих задачах
                                        </p>
                                    </div>
                        ...
                        <button class="feedbacks__content-prev" ref={prevBtn}>
                            <img src="/img/landing/slide-right.svg" alt="Предыдущий слайд" />
                        </button>
                        <button class="feedbacks__content-next" ref={nextBtn}>
                            <img src="/img/landing/slide-left.svg" alt="Следующий слайд" />
                        </button>
                    </div>
                </div>
            </section>
