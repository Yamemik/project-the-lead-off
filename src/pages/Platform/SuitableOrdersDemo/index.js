...
const SuitableOrdersDemo = () => {
    const [suitableOrders, setSuitableOrders] = useState([]);
    const [isLoading, setIsLoading] = useState(true);
    const [isOpenMobileFilters, setIsOpenMobileFilters] = useState(window.innerWidth > 768);
    ...
    useEffect(() => {
        JSON.parse(localStorage.getItem("demo")).orders.suitables.map(order => {
...
export default SuitableOrdersDemo;
